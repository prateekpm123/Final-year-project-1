      ...
      <nav class="navbar navbar-inverse">
		...
		<div id="page-wrapper">
			<div class="main-page general">
				<h2 class="title1">Search Students</h2>
				<div class="panel-info widget-shadow">
					<h4 class="title2">Criteria</h4>
					<div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
						...
						<div class="form-group">
                          <label for="inputEmail3" class="col-sm-4 control-label">Relocation</label>
                             <div class="col-sm-8">
                                 Not Ready <Input type = "Radio" name="relocation" value="n" checked> &nbsp; &nbsp;
                                 Ready <Input type = "Radio" name="relocation" value="y"> &nbsp; &nbsp;
                                 Any <Input type = "Radio" name="relocation" value="b">
                             </div>
                         </div>						 
						 <div class="form-group">
                          <label for="inputEmail3" class="col-sm-4 control-label">Bond</label>
                             <div class="col-sm-8">
                                 Not Ready <Input type = "Radio" name="bond" value="n" checked> &nbsp; &nbsp;
                                 Ready <Input type = "Radio" name="bond" value="y"> &nbsp; &nbsp;
                                 Any <Input type = "Radio" name="bond" value="b">
                             </div>
                         </div>
                    </div>
                </div>
