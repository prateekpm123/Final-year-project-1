	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
		...
		<div id="page-wrapper">
			<div class="main-page general">
				<h2 class="title1">Select Company</h2>
				<div class="panel-info widget-shadow">
				<form method="post" name="formname" action="send_message_company.php">
					<div class="col-md-12">
						<div class="form-group">
							<br><label for="input requiredEmail3" class="col-md-2 control-label">Company Name</label>
							<div class="col-md-10">
					...
					<div class="box-footer">
						<input type="submit" class="btn btn-info pull-right" name="select" id="seelect" value="Select">
					</div>
					<div class="clearfix"> </div>
				</form>
				</div>
